...
| B8 | ✨ | Liens vers Android (Play Store) et Apple (App Store) depuis le site | ouvert | Demandé le 10/08/2026. Suppose une application mobile existante au préalable — actuellement aucune app n'est développée (le site est un simple site web responsive, pas une PWA installable ni une app native). À clarifier avant d'aller plus loin : app native à développer, ou juste rendre le site installable comme PWA (plus simple, pas de présence sur les stores mais icône sur l'écran d'accueil) ? |
